...
*/
;(function() {
var CORDOVA_JS_BUILD_LABEL = '3.4.0-dev-567a2fd';
...
function webosPortsExec(success, fail, service, action, args) {
    if (callbackId % 2) {
        callbackId++;
    }
...
// file: lib/webos-ports/platform.js
